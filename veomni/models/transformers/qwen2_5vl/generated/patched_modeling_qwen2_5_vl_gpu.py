...
#    - method_override: Qwen2_5_VLModel.get_rope_index
#      Override Qwen2_5_VLModel.get_rope_index
...
# Methods patched: get_placeholder_mask, get_image_features, get_video_features, forward, get_rope_index
# ======================================================================
        ...
        for batch_index, ids in enumerate(input_ids):
            ...
            for modality, group in itertools.groupby(types.tolist()):
                ...
                vision_positions = self.get_vision_position_ids(
                    current_pos, grid, 1, merge, interval, device=ids.device
                )
